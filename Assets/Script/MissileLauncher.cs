...
public class MissileLauncher : MonoBehaviour
{
    ...
    private void AchieveLock()
    {
        ...
        {
            effectAudioSource.PlayOneShot(lockedSound);
        }
    ...
    private void LoseLock()
    {
        ...
        if (hadLock)
        {
            // Play lock lost sound
            if (lockLostSound != null && effectAudioSource != null)
            {
                effectAudioSource.PlayOneShot(lockLostSound);
            }
    ...
    private void UpdateLockAudio()
    {
        ...
        if (isLocking && lockProgress < 1f && lockingSound != null)
        {
            ...
            {
                lockAudioSource.PlayOneShot(lockingSound);
    ...
    private void FireMissile()
    {
        ...
        {
            effectAudioSource.PlayOneShot(launchSound);
        }
